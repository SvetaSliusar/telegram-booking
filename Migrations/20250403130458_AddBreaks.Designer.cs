...
namespace TelegramBookingBot.Migrations
{
    ...
    [Migration("20250403130458_AddBreaks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Telegram.Bot.Examples.WebHook.Models.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Telegram.Bot.Examples.WebHook.Models.Break", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Telegram.Bot.Examples.WebHook.Models.ReminderSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Telegram.Bot.Examples.WebHook.Models.WorkingHours", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Telegram.Bot.Examples.WebHook.Models.Booking", b =>
                {
                    b.HasOne("Telegram.Bot.Examples.WebHook.Models.Client", "Client")
                        .WithMany("Bookings")
                    ...
                    b.HasOne("Telegram.Bot.Examples.WebHook.Models.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("Telegram.Bot.Examples.WebHook.Models.Break", b =>
                {
                    b.HasOne("Telegram.Bot.Examples.WebHook.Models.WorkingHours", "WorkingHours")
                        .WithMany("Breaks")
            ...
            modelBuilder.Entity("Telegram.Bot.Examples.WebHook.Models.Company", b =>
                {
                    b.HasOne("Telegram.Bot.Examples.WebHook.Models.Token", "Token")
                        .WithOne("Company")
                        .HasForeignKey("Telegram.Bot.Examples.WebHook.Models.Company", "TokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Telegram.Bot.Examples.WebHook.Models.ReminderSettings", b =>
                {
                    b.HasOne("Telegram.Bot.Examples.WebHook.Models.Company", "Company")
                        ...
                        .HasForeignKey("Telegram.Bot.Examples.WebHook.Models.ReminderSettings", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
